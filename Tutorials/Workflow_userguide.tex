...
\vspace{0.1cm}
\section{Example Usage of the Workflow Tools}
\vspace{0.1cm}

The following section illustrates example usage of the workflow tools. Herein, we assume that the
...
\subsection{Setup of RBFE calculations}

\begin{itemize}
	\item Create and configure \textit{setup\_fe}\newline

		\vspace{0.2cm}
		cd /home/user/GitLab/Alchemical\_fe/bin \newline
		export pathTOWFToolKit=/home/user/GitLab/Alchemical\_fe \newline
	...
	\item Choose a working directory
         	\centerline{mkdir /home/user/rbfe}
	\item  kk
\end{itemize}
