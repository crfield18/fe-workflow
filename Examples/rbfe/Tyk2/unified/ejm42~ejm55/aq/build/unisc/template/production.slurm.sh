...
REVERSE=false
if [ "${REVERSE}" = true ]; then lams=( 1.00000000 0.90909091 0.81818182 0.72727273 0.63636364 0.54545455 0.45454545 0.36363636 0.27272727 0.18181818 0.09090909 0.00000000 ); fi
