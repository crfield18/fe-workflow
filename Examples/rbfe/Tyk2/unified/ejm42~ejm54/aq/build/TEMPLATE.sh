...
cat<<EOF > equil.slurm
#!/bin/bash
#SBATCH --job-name="eq_ejm42~ejm54.slurm"
#SBATCH --output="eq_ejm42~ejm54.slurm.slurmout"
#SBATCH --error="eq_ejm42~ejm54.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_ejm42~ejm54.slurm"
#SBATCH --output="pr_ejm42~ejm54.slurm.slurmout"
#SBATCH --error="pr_ejm42~ejm54.slurm.slurmerr"
#SBATCH --partition=null
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
