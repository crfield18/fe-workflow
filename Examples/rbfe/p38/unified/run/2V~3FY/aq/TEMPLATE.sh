...
#!/bin/bash
#SBATCH --job-name="eq_2V~3FY.slurm"
#SBATCH --output="eq_2V~3FY.slurm.slurmout"
#SBATCH --error="eq_2V~3FY.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2V~3FY.slurm"
#SBATCH --output="pr_2V~3FY.slurm.slurmout"
#SBATCH --error="pr_2V~3FY.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
