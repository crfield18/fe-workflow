...
#!/bin/bash
#SBATCH --job-name="eq_3FY~3FH.slurm"
#SBATCH --output="eq_3FY~3FH.slurm.slurmout"
#SBATCH --error="eq_3FY~3FH.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_3FY~3FH.slurm"
#SBATCH --output="pr_3FY~3FH.slurm.slurmout"
#SBATCH --error="pr_3FY~3FH.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
