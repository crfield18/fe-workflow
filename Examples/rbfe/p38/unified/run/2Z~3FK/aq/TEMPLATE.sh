...
#!/bin/bash
#SBATCH --job-name="eq_2Z~3FK.slurm"
#SBATCH --output="eq_2Z~3FK.slurm.slurmout"
#SBATCH --error="eq_2Z~3FK.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2Z~3FK.slurm"
#SBATCH --output="pr_2Z~3FK.slurm.slurmout"
#SBATCH --error="pr_2Z~3FK.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
