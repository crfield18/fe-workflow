...
timask1         = '@1-45'
timask2         = '@46-92'
scmask1         = '@16,24,27,37,43-45'
scmask2         = '@53,62,73-74,76,80-82,86'
scalpha         = 0.5
scbeta          = 1.0
...
#!/bin/bash
#SBATCH --job-name="eq_2Z~3FQ.slurm"
#SBATCH --output="eq_2Z~3FQ.slurm.slurmout"
#SBATCH --error="eq_2Z~3FQ.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2Z~3FQ.slurm"
#SBATCH --output="pr_2Z~3FQ.slurm.slurmout"
#SBATCH --error="pr_2Z~3FQ.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
