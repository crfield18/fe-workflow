...
timask1         = '@1-45'
timask2         = '@46-94'
scmask1         = '@24,37,40,43-45'
scmask2         = '@72-74,78-79,90-94'
scalpha         = 0.5
scbeta          = 1.0
...
#!/bin/bash
#SBATCH --job-name="eq_2Z~3FW.slurm"
#SBATCH --output="eq_2Z~3FW.slurm.slurmout"
#SBATCH --error="eq_2Z~3FW.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2Z~3FW.slurm"
#SBATCH --output="pr_2Z~3FW.slurm.slurmout"
#SBATCH --error="pr_2Z~3FW.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
