...
#!/bin/bash
#SBATCH --job-name="eq_2AA~3FW.slurm"
#SBATCH --output="eq_2AA~3FW.slurm.slurmout"
#SBATCH --error="eq_2AA~3FW.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2AA~3FW.slurm"
#SBATCH --output="pr_2AA~3FW.slurm.slurmout"
#SBATCH --error="pr_2AA~3FW.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
