...
#!/bin/bash
#SBATCH --job-name="eq_2AA~2Z.slurm"
#SBATCH --output="eq_2AA~2Z.slurm.slurmout"
#SBATCH --error="eq_2AA~2Z.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_2AA~2Z.slurm"
#SBATCH --output="pr_2AA~2Z.slurm.slurmout"
#SBATCH --error="pr_2AA~2Z.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
