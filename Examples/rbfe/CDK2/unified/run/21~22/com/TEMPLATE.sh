...
#!/bin/bash
#SBATCH --job-name="eq_21~22.slurm"
#SBATCH --output="eq_21~22.slurm.slurmout"
#SBATCH --error="eq_21~22.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_21~22.slurm"
#SBATCH --output="pr_21~22.slurm.slurmout"
#SBATCH --error="pr_21~22.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
