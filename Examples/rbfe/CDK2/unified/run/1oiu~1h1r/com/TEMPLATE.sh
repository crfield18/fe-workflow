...
#!/bin/bash
#SBATCH --job-name="eq_1oiu~1h1r.slurm"
#SBATCH --output="eq_1oiu~1h1r.slurm.slurmout"
#SBATCH --error="eq_1oiu~1h1r.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_1oiu~1h1r.slurm"
#SBATCH --output="pr_1oiu~1h1r.slurm.slurmout"
#SBATCH --error="pr_1oiu~1h1r.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
