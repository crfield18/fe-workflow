...
#!/bin/bash
#SBATCH --job-name="eq_17~20.slurm"
#SBATCH --output="eq_17~20.slurm.slurmout"
#SBATCH --error="eq_17~20.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_17~20.slurm"
#SBATCH --output="pr_17~20.slurm.slurmout"
#SBATCH --error="pr_17~20.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
