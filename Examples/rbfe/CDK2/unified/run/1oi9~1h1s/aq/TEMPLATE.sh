...
#!/bin/bash
#SBATCH --job-name="eq_1oi9~1h1s.slurm"
#SBATCH --output="eq_1oi9~1h1s.slurm.slurmout"
#SBATCH --error="eq_1oi9~1h1s.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_1oi9~1h1s.slurm"
#SBATCH --output="pr_1oi9~1h1s.slurm.slurmout"
#SBATCH --error="pr_1oi9~1h1s.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
