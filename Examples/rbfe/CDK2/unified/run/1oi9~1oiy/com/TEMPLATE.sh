...
#!/bin/bash
#SBATCH --job-name="eq_1oi9~1oiy.slurm"
#SBATCH --output="eq_1oi9~1oiy.slurm.slurmout"
#SBATCH --error="eq_1oi9~1oiy.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_1oi9~1oiy.slurm"
#SBATCH --output="pr_1oi9~1oiy.slurm.slurmout"
#SBATCH --error="pr_1oi9~1oiy.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
