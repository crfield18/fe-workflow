...
#!/bin/bash
#SBATCH --job-name="eq_26~28.slurm"
#SBATCH --output="eq_26~28.slurm.slurmout"
#SBATCH --error="eq_26~28.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_26~28.slurm"
#SBATCH --output="pr_26~28.slurm.slurmout"
#SBATCH --error="pr_26~28.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
