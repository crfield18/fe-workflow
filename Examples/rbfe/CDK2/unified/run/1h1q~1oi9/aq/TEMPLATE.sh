...
#!/bin/bash
#SBATCH --job-name="eq_1h1q~1oi9.slurm"
#SBATCH --output="eq_1h1q~1oi9.slurm.slurmout"
#SBATCH --error="eq_1h1q~1oi9.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_1h1q~1oi9.slurm"
#SBATCH --output="pr_1h1q~1oi9.slurm.slurmout"
#SBATCH --error="pr_1h1q~1oi9.slurm.slurmerr"
#SBATCH --partition=general-long-gpu
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
