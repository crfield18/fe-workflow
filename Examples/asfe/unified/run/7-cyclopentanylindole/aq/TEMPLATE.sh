...
#!/bin/bash
#SBATCH --job-name="eq_7-cyclopentanylindole.slurm"
#SBATCH --output="eq_7-cyclopentanylindole.slurm.slurmout"
#SBATCH --error="eq_7-cyclopentanylindole.slurm.slurmerr"
