...
#!/bin/bash
#SBATCH --job-name="eq_2-methylindole~methane.slurm"
#SBATCH --output="eq_2-methylindole~methane.slurm.slurmout"
#SBATCH --error="eq_2-methylindole~methane.slurm.slurmerr"
