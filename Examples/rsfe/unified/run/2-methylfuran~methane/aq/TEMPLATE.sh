...
#!/bin/bash
#SBATCH --job-name="eq_2-methylfuran~methane.slurm"
#SBATCH --output="eq_2-methylfuran~methane.slurm.slurmout"
#SBATCH --error="eq_2-methylfuran~methane.slurm.slurmerr"
