...
cat<<EOF > equil.slurm
#!/bin/bash
#SBATCH --job-name="eq_methanol~methane.slurm"
#SBATCH --output="eq_methanol~methane.slurm.slurmout"
#SBATCH --error="eq_methanol~methane.slurm.slurmerr"
...
cat<<EOF > prod.slurm
#!/bin/bash
#SBATCH --job-name="pr_methanol~methane.slurm"
#SBATCH --output="pr_methanol~methane.slurm.slurmout"
#SBATCH --error="pr_methanol~methane.slurm.slurmerr"
#SBATCH --partition=null
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
#SBATCH --gres=gpu:8
